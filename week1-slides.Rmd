...
* Some other tools: gephi, or today, web browsers (specific occassions)
...
**Search engines:**
* are mediators of access -> They play a crucial role in culture.
  * Gatekeepers, curators, filterers
* Research topics by themselves
...
We need to think about how a question can be considered to think about how it can be broken down into query terms for each method being used. 

* understand and refine a research question: 
...
We can think of climate as a keyword. We can use `Climate change`, but there are neologisms such as `climate justice` which have overlapping meanings, but do not refer to the same idea nor have the same implications, connotations (political, activism, timeframe)... what kind of term are we interested with?

...
## Introduction to Digital Objects and Digital Methods Labs
...
In the labs, we will lab will teach you a new method or technique and we will use case studies to help you with the understanding how the technique might be used. You will be developing your own separate research topic in your groups.

## Labs overview

In this lab session, we will give you an overview of the lab sessions for this term. 

* Week 1:	Query Design and Search as Research – Query design and Search Engines.

*	Week 2:	Data Affordances – We will explore Twitter and Reddit using R packages and discuss the changing formats.

* Week 3: Visual Analysis - We will explore how to use images.  

*	Week 4:	Network Analysis – This week will look at Twitter replies to explore the network as digital object and will visualise the results using Gephi. 

*	Week 5:	Text Analysis 1 – We will use the results of the Reddit work to explore some text analysis techniques. 

*	Week 6:	Reading Week – No labs

*	Week 7:	Text Analysis 2 – We will use the results of the Reddit work with an automated reading. 

*	Week 8:	Visualisation – This week will reflect on the various techniques that have been introduced and storytelling through visualisation. 

*	Week 9:	Project Surgery

*	Week 10:	Presentations – Each group will give a talk of 5 – 8 minutes with slides. 
...
What is it that we want to use as keywords to begin our search? What does a keyword suggest: is it always an explicit meaning or are there implicit meanings? 

## Search 

Using search engines means that we are re-purposing the device to look at how the engine works. Here I want to think about the query design in search. We can use search to consider the affordances of the medium and as a method. As we search through the search engines, we are being presented aggregated results determined by algorithms and aggregated searches.
